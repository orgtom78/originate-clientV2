// src/views/register-multi-steps/StepLoanFinancials.tsx
...
const StepLoanFinancials = ({ handlePrev, handleNext, formData, updateFormData, onSubmit }: StepProps) => {
  const {
    control,
    handleSubmit,
...
export default StepLoanFinancials
