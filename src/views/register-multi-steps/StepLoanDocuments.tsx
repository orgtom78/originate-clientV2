// src/views/register-multi-steps/StepLoanDocuments.tsx
...
const StepLoanDocuments = ({ handlePrev, formData, updateFormData, onSubmit }: StepProps) => {
  const {
    control,
    handleSubmit,
...
export default StepLoanDocuments
